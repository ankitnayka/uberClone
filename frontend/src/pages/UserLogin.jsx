    ...
    return (
        <div className="h-screen w-full bg-[#FFB121] flex justify-around flex-col items-center" >
            ...
            <div className=" flex flex-col items-center justify-center  my-32   ">
                ...
                <p>
                    click here to <Link to='/signup' className="text-black shadow-lg font-bold">create new Account </Link>
                </p>

            </div>
            {/* //captain */}
            <Link to='/captain-login'>
                <Button className="my-3 mb-10 shadow-lg text-white w-48 bg-[#333333]">sign in as captain</Button>
            </Link>
        </div>
    )
}
